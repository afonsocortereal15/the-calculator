...
# minus button
button_minus = Button(gui, text=' - ', fg='white', bg='#454545', font='Arial 20', relief=RIDGE,
                command=lambda: press("-"), height=2, width=14)
...
# plus button
button_plus = Button(gui, text=' + ', fg='white', bg='#454545', font='Arial 20', relief=RIDGE,
                command=lambda: press("+"), height=2, width=14)
button_plus.grid(row=4, column=3, sticky='NSEW')

# squared button
button_squared = Button(gui, text=' x^y ', fg='white', bg='#454545', font='Arial 20', relief=RIDGE,
                    command=lambda: press('**'), height=2, width=14)
button_squared.grid(row=5, column=0, sticky='NSEW')
